...
uint32_t find_OSSerializer_serialize(void) {
	switch (target_environment) {
		...
		case iPhone41_iOS933: return 0x318388; //80139388
...
uint32_t find_OSSymbol_getMetaClass(void) {
	switch (target_environment) {
		...
		case iPhone41_iOS921: return 0x312f18; //80313f18
...
uint32_t find_bufattr_cpx(void) {
	switch (target_environment) {
		...
		case iPhone41_iOS921: return 0xd8750; //800d9750
...
uint32_t find_copyin(void) {
	switch (target_environment) {
		...
		case iPhone41_iOS921: return 0xc6754; //800c7754
...
uint32_t find_vm_kernel_addrperm(void) {
	switch (target_environment) {
		...
		case iPhone41_iOS921: return 0x44e840; //0x8044f844 - 4 = 0x8044f840
		case iPhone41_iOS930: return 0x455844;
		case iPhone41_iOS931: return 0x455844;
		case iPhone41_iOS932: return 0x455844;
		case iPhone41_iOS933: return 0x455844; //0x80456848 -4 = 0x80456844
...
uint32_t find_kernel_pmap(void) {
	switch (target_environment) {
		...
		case iPhone41_iOS921: return 0x3ef444; //803f0444
...
uint32_t find_setreuid(void) {
	switch (target_environment) {
		...
		//case iPhone41_iOS921: return ; //TODO, can't find f0b503af2de9000d87b0044602910394d1f800b04d68dff7
		case iPhone41_iOS930: return 0x2a977c;
		case iPhone41_iOS931: return 0x2a977c;
		case iPhone41_iOS932: return 0x2a985c;
		case iPhone41_iOS933: return 0x2a9988; //802aa988
